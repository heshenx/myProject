...
_28b.window.css({"z-index":$.fn.window.defaults.zIndex++,width:_28b.window._outerWidth()});
...
},message:"字段长度 必须在 {0}到{1}之间"},remote:{validator:function(_4ef,_4f0){
var data={};
data[_4f0[1]]=_4ef;
...
$.ajax({url:data,async:false,data:_59b,dataType:"json",success:function(data){
_59c(data);
},error:function(){
...
_b92(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确认",buttons:[{text:function(_ba7){
